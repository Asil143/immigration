  ...
  phases: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "r3b", text: "Also update your employer directly in the SEVP Portal (sevp.ice.gov/opt)", type: "online", note: "Most students don't know this exists. After graduation you have direct access to update your own SEVIS record — employer, address, and more. Login with your SEVIS ID (N-number on I-20) + date of birth + passport number.", link: { label: "SEVP Portal", url: "https://sevp.ice.gov/opt/" } },
        ...
        { id: "r6", text: "If changing jobs, report new employer to DSO AND update in SEVP Portal within 10 days", type: "action", link: { label: "SEVP Portal", url: "https://sevp.ice.gov/opt/" } },
